...
<html lang="ru">
  <head>
    ...
    <meta http-equiv="refresh" content="0; url=../lk/login.php" />
</head>
  <body>
    <script>
      // Canonical page moved to /lk/login.php
      try {
        location.replace("../lk/login.php" + (location.search || ""));
      } catch (e) {}
    </script>
    ...
    <main id="content" class="section">
      <div class="container">
        <section class="card reveal auth-wrap">
          ...
          <p class="muted">
            Войдите в личный кабинет, чтобы видеть полисы, оплаты и заявки.
          </p>
          <form id="loginForm" class="form" method="post" action="../actions/login.php" novalidate>
            <input type="hidden" name="back" value="../auth/login.php" />
