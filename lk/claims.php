      ...
      <div class="container lk-shell">
        ...
        <section class="card reveal">
          <div class="lk-topline">
            <div>
              <h1 class="u-mb6">Случаи</h1>
              <p class="muted u-m0">
                Ваши обращения по страховым случаям.
              </p>
            </div>
            <div class="inline">
          ...
          <div id="lkClaims">
            <div class="grid2">
              <div class="card u-shadow-none">
                <h2 class="h3">Мои заявки</h2>
                <div class="inline u-mb10">
                  <span class="badge">Найдено: <b id="count"><?= count(lk_claims($user)) ?></b></span>
                </div>
                <div id="claimsBox" class="breakdown"><?= lk_claims_table($user) ?></div>
              </div>

              <div class="card u-shadow-none">
                <h2 class="h3">Быстрая заявка</h2>
                <form id="claimMiniForm" class="form" method="post" action="../actions/claim_submit.php" novalidate>
                  <input type="hidden" name="back" value="../lk/claims.php" />
                  <div class="field">
                    <label for="policyId">Полис</label
                  ...
                  <div class="field">
                    ...
                    ><textarea id="desc" rows="4" required name="desc"></textarea>
                  </div>
